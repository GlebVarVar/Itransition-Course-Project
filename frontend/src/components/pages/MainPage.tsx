                    ...
                    <Card>
                      ...
                      <Card.Body>
                        ...
                        <Row
                          ...
                          onClick={() => navigate(`/posts/${post.id}`)}>
                          <ReactMarkdown>
                            {post.postText.length > 500
                              ? `${post.postText.substr(0, 500)}...`
                              : post.postText}
                          </ReactMarkdown>
                        </Row>
                        ...
                        <Row onClick={() => navigate(`/posts/${post.id}`)}>
                          <div>
                            {post.Tags.map((tag, key) => {
                              return (
                                <Badge style={{ margin: '0 10px 0 10px' }} bg="info" key={key}>
                                  {tag.tag}
                                </Badge>
                              );
                            })}
                        ...
                        <Container>
                          <Row
                            ...
                            style={{ fontWeight: 'bold', margin: '2% 0' }}>
                            <Col>
                              <Row>
                                <p>{t('likes')}</p>
                              </Row>
                            ...
                            <Col>
                              ...
                              <Row>{<StarRatingStatic rating={totalRating(post)} />}</Row>
                            </Col>
                            ...
                            <Col>
                              ...
                              <Row>{<StarRatingStatic rating={ownerRating(post)} />}</Row>
                            </Col>
                          </Row>
                        </Container>
                        <Row>
            ...
            {buttonDisplay == true ? (
              <div className="d-grid gap-2" style={{ marginTop: '5%' }}>
                <Button
                  variant="success"
                  size="lg"
                  onClick={() => setCountOfDisplay(countOfDisplay + 4)}>
                  {t('morePosts')}
                </Button>
              </div>
            ) : (
