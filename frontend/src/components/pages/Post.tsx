                    ...
                    {postObject.Photos.map((photo, key) => {
                      return (
                        <Carousel.Item key={key}>
                          <img className="d-block w-100" src={photo.Photo} alt="First slide" />
                        </Carousel.Item>
                      );
                    })}
                  </Carousel>
                      ...
                      <Row>
                        {context != null ? (
                          <Col style={{ fontWeight: 'bold', fontSize: '20px' }}>
                            Click me!
                            <ThumbUpAltIcon
                              style={{ color: likes.like ? '#2193F9' : '#3FF4FC' }}
                              onClick={likePost}
                            />
                          </Col>
                        ) : null}
                    ...
                    <Tab eventKey="Rating" title="Rating">
                      <Row style={{ fontWeight: 'bold', fontSize: '20px' }} xs={1} lg={3}>
                        ...
                        <Col>
                          ...
                          <Row>
                            <StarRatingStatic rating={totalRating(postObject)} />
                          </Row>
                        </Col>
                        <Col>
                          <Row>Author's Rating</Row>
                          <Row>
                            <StarRatingStatic rating={ownerRating(postObject)} />{' '}
                          </Row>
                        </Col>
                      </Row>
                    </Tab>
                ...
                <Container>
                  <Card border="primary">
                    ...
                    <Card.Footer className="text-muted">
                      ...
                      {postObject.createdAt !== undefined
